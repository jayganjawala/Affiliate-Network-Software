    ...
    <section className="py-5 poppins-regular">
      <div className="container">
        ...
        <p className="text-muted mt-3 mb-0">
          Continue your journey towards smarter investment decisions
        </p>
        <div className="row justify-content-between mt-3 mt-md-0">
          ...
          <div className="col-md-6 mt-4 order-md-1 order-2">
            ...
            <div className="d-flex mb-4">
              ...
              <div>
                ...
                <p className="text-muted small mb-0">
                  Connect brokers, IBs, affiliates, signal providers, fintech
                  companies & agencies in one powerful ecosystem
                </p>
              </div>
            </div>
            ...
            <div className="d-flex mb-4">
              ...
              <div>
                <h6 className="fw-semibold mb-1">Lead Generation Platform</h6>
                <p className="text-muted small mb-0">
                  Deliver high-quality, geo-targeted & conversion-ready trader
                  leads to brokers
                </p>
              </div>
            </div>
            ...
            <div className="d-flex mb-4">
              ...
              <div>
                <h6 className="fw-semibold mb-1">Broker Comparison Service</h6>
                <p className="text-muted small mb-0">
                  Independent evaluation & ranking platform to help traders
